...
class CustomError {
    ...
    constructor(title = "INTERNAL SERVER ERROR", description = "INTERNAL SERVER ERROR", error = {}, statusCode = HTTP_STATUS_CODE.ENUM.INTERNAL_SERVER_ERROR) {
        this.message = {
            title,
            description,
            error
...
class SequelizeError extends CustomError {
    constructor(error) {
        ...
        if (error instanceof Sequelize.ValidationError || error instanceof Sequelize.AggregateError) {
            title = "Bad Request";
        ...
        super(title, description, { ...error.original, message: error.message } || error.errors || error.error || error.message, statusCode);
    }
...
class UnauthorizedError extends CustomError {
    constructor(error, description = "Unauthorized") {
        super("Unauthorized", description, error, HTTP_STATUS_CODE.ENUM.UNAUTHORIZED);
    }
}
...
class MethodNotAllowedError extends CustomError {
    constructor(error, description = "Method Not Allowed") {
        super("Method Not Allowed", description, error, HTTP_STATUS_CODE.ENUM.METHOD_NOT_ALLOWED);
    }
}

class NotAcceptableError extends CustomError {
    constructor(error, description = "Not Acceptable") {
        super("Not Acceptable", description, error, HTTP_STATUS_CODE.ENUM.NOT_ACCEPTABLE);
    }
}

class RequestTimeoutError extends CustomError {
    constructor(error, description = "Request Timeout") {
        super("Request Timeout", description, error, HTTP_STATUS_CODE.ENUM.REQUEST_TIMEOUT);
    }
}
...
class LengthRequiredError extends CustomError {
    constructor(error, description = "Length Required") {
        super("Length Required", description, error, HTTP_STATUS_CODE.ENUM.LENGTH_REQUIRED);
    }
}

class PreconditionFailedError extends CustomError {
    constructor(error, description = "Precondition Failed") {
        super("Precondition Failed", description, error, HTTP_STATUS_CODE.ENUM.PRECONDITION_FAILED);
    }
}

class PayloadTooLargeError extends CustomError {
    constructor(error, description = "Payload Too Large") {
        super("Payload Too Large", description, error, HTTP_STATUS_CODE.ENUM.PAYLOAD_TOO_LARGE);
    }
}

class URITooLongError extends CustomError {
    constructor(error, description = "URI Too Long") {
        super("URI Too Long", description, error, HTTP_STATUS_CODE.ENUM.URI_TOO_LONG);
    }
}

class UnsupportedMediaTypeError extends CustomError {
    constructor(error, description = "Unsupported Media Type") {
        super("Unsupported Media Type", description, error, HTTP_STATUS_CODE.ENUM.UNSUPPORTED_MEDIA_TYPE);
    }
}

class TooManyRequestsError extends CustomError {
    constructor(error, description = "Too Many Requests") {
        super("Too Many Requests", description, error, HTTP_STATUS_CODE.ENUM.TOO_MANY_REQUESTS);
    }
}

class InternalServerErrorError extends CustomError {
    constructor(error, description = "Internal Server Error") {
        super("Internal Server Error", description, error, HTTP_STATUS_CODE.ENUM.INTERNAL_SERVER_ERROR);
    }
}

class NotImplementedError extends CustomError {
    constructor(error, description = "Not Implemented") {
        super("Not Implemented", description, error, HTTP_STATUS_CODE.ENUM.NOT_IMPLEMENTED);
    }
}
...
class ServiceUnavailableError extends CustomError {
    constructor(error, description = "Service Unavailable") {
        super("Service Unavailable", description, error, HTTP_STATUS_CODE.ENUM.SERVICE_UNAVAILABLE);
    }
}

class GatewayTimeoutError extends CustomError {
    constructor(error, description = "Gateway Timeout") {
        super("Gateway Timeout", description, error, HTTP_STATUS_CODE.ENUM.GATEWAY_TIMEOUT);
    }
}
