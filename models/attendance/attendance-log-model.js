...
const { AttendanceLogType } = require("./attendance-log-type-enum");
...
module.exports = (sequelize, DataTypes) => {
    ...
    class AttendanceLog extends Model {
        ...
        static associate(models) {
            this.attendance = AttendanceLog.belongsTo(models.attendance, {foreignKey:'attendance_id', as: 'attendence'})
        }
